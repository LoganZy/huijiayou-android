...
public class OverCouponAdapter extends RecyclerView.Adapter<OverCouponAdapter.CouponViewHolder>{

    ArrayList<Coupon> coupons;
    Context context;
    View.OnClickListener onClickListener;

    public OverCouponAdapter(ArrayList<Coupon> coupons, Context context, View.OnClickListener onClickListener) {
    ...
    public CouponViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new CouponViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_activity_coupon_over,parent,false));
    }
