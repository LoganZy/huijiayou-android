...
public class OutSideWebViewFrame extends WebView implements WebViewJavascriptBridge,JavascriptInterface {
	...
	public OutSideWebViewFrame(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public OutSideWebViewFrame(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public OutSideWebViewFrame(Context context) {
		super(context);
		init();
	}
